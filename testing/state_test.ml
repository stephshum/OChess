...
let bb = do' (Move ((6,8),(6,6))) a
let cc = do' (Move ((6,3),(6,5))) bb
let dd = do' (Move ((7,9),(2,4))) cc
let ff = do' (Move ((7,2),(2,7))) dd
let gg = do' (Move ((8,9),(7,7))) ff
let hh = do' (Move ((8,2),(7,4))) gg
let ii = do' (Move ((6,9),(8,9))) hh


let tests = [

  "castle" >:: (fun _ -> assert_equal (List.assoc (7,9) ii.pc_loc)
                   {name = Rook false;pcolor = White});
